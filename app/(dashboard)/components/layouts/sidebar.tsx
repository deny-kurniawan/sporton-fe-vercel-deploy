...
import { FiBox, FiCreditCard, FiLayers, FiLoader, FiLogOut, FiShoppingCart } from "react-icons/fi";
...
const Sidebar = () => {
    ...
    return <aside className="w-80 min-h-screen bg-white border-r border-gray-100 flex flex-col fixed left-0 top-0">
        <div className="py-8 px-14 border-b border-gray-200">
            <Image src="/image/admin/logo-admin.svg" 
            alt="SportOn Admin" width={215} height={36}/>
        </div>
        ...
        <Link href="#" className="flex gap-3 font-medium py-3 px-4.5 mx-5
         hover:bg-gray-100 duration-300 rounded-lg mt-auto mb-10">
            <FiLogOut size={24}/>
            Log Out
        </Link>
    </aside>;
